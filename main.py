...
def editDegree(cid, sid):
    studentId = sid.args.get('studentId')
    conId = cid.args.get('conId')
    ...
    cursor.execute("UPDATE Students SET concentrationId = %d WHERE studentId = %d;", (conId,studentId,))
...
def displayDegrees(dept):
    department = dept.args.get('dept')
    ...
    cursor.callproc('displayDegrees', (department,))
